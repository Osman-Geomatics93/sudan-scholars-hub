          ...
          <div className="hidden md:flex items-center gap-0 lg:gap-1">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="relative px-2 lg:px-4 py-2 text-sm lg:text-base text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors duration-300 group"
              >
            ...
            <div className="relative" ref={turkeyMenuRef}>
              <button
                ...
                className="relative flex items-center gap-1 px-2 lg:px-4 py-2 text-sm lg:text-base text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors duration-300 group"
