...
import { Menu, X, GraduationCap, User, Bookmark, LogOut, ChevronDown, BookOpen, HelpCircle, Lightbulb, Globe, Calendar, Building2, FileQuestion, Calculator, Sparkles, FileText, PenLine } from 'lucide-react';
...
export function Navbar({ locale }: NavbarProps) {
  ...
  const resourceLinks = [
    ...
    { href: `/${locale}/loi-builder`, label: isRTL ? 'منشئ خطاب النية' : 'LOI Builder', icon: PenLine },
