        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            {formData.eligibility.map((item, index) => (
              <div key={index} className="mb-2 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-red-100 dark:bg-red-950/50 px-3 py-2 text-red-600 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-900/50"
                >
                  -
                </button>
              </div>
            ...
            <button
              ...
              className="mt-2 rounded-lg bg-gray-100 dark:bg-gray-800 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700"
            >
              + Add Item
            </button>
          </div>
