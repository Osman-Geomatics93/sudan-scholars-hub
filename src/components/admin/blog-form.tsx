    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="rounded-xl bg-white dark:bg-gray-900 p-6 shadow-sm dark:shadow-gray-900/50">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              Content (English) * <span className="text-gray-400 dark:text-gray-500 text-xs">(Markdown supported)</span>
            </label>
            <textarea
              ...
              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 font-mono text-sm dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
            />
          </div>

          <div>
            <label className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-300">
              المحتوى (عربي) * <span className="text-gray-400 dark:text-gray-500 text-xs">(يدعم Markdown)</span>
            </label>
            <textarea
        ...
        <div className="space-y-4">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 px-4 py-2 dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
            />
            <button
              type="button"
              onClick={addTag}
              className="inline-flex items-center gap-1 rounded-lg bg-primary-600 dark:bg-primary-500 px-4 py-2 text-white hover:bg-primary-700 dark:hover:bg-primary-600"
            >
