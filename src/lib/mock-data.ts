...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    roleAr: 'مديرة نجاح الطلاب',
    bio: 'Dedicated to helping students navigate the scholarship application process.',
    bioAr: 'متخصصة في مساعدة الطلاب في التنقل خلال عملية التقديم للمنح.',
