        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-red-100 max-w-2xl mx-auto">
              {isRTL
                ? 'اكتشف الجامعات الخاصة التركية ومتطلبات القبول'
                : 'Discover Turkish private universities and admission requirements'}
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {isRTL
                ? 'نعمل على إضافة قائمة شاملة بالجامعات الخاصة التركية'
                : 'We are working on adding a comprehensive list of Turkish private universities'}
            </p>
          </div>
        </Container>
      </section>
