        ...
        <Container>
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              {isRTL ? 'ما هي المفاضلة ؟' : 'What is the Trade-off?'}
            </h1>
            <p className="text-lg md:text-xl text-red-100 max-w-2xl mx-auto">
              {isRTL
                ? 'تعرف على نظام المفاضلة في الجامعات التركية وكيفية عمله'
                : 'Learn about the trade-off system in Turkish universities and how it works'}
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {isRTL
                ? 'نعمل على إضافة شرح شامل لنظام المفاضلة في تركيا'
                : 'We are working on adding a comprehensive explanation of the trade-off system in Turkey'}
            </p>
          </div>
        </Container>
      </section>
