        ...
        <Container>
          <div className="text-center">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
              {isRTL ? 'اليوس الموحد' : 'Unified YÖS'}
            </h1>
            <p className="text-lg md:text-xl text-red-100 max-w-2xl mx-auto">
              {isRTL
                ? 'معلومات حول امتحان اليوس الموحد في تركيا'
                : 'Information about the Unified YÖS exam in Turkey'}
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {isRTL
                ? 'نعمل على إضافة معلومات شاملة حول اليوس الموحد'
                : 'We are working on adding comprehensive information about Unified YÖS'}
            </p>
          </div>
        </Container>
      </section>
