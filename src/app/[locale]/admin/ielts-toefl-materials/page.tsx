            ...
            <div>
              ...
              <dl className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0646\u0648\u0639 \u0627\u0644\u0645\u0627\u062F\u0629' : 'Material Type'}</dt>
                  <dd className="text-gray-900 capitalize">{selectedMaterial.materialType}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0627\u0644\u0635\u0639\u0648\u0628\u0629' : 'Difficulty'}</dt>
                ...
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0627\u0644\u0644\u063A\u0629' : 'Language'}</dt>
                  <dd className="text-gray-900">{selectedMaterial.language === 'en' ? 'English' : selectedMaterial.language === 'ar' ? '\u0627\u0644\u0639\u0631\u0628\u064A\u0629' : 'Both'}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0631\u064F\u0641\u0639\u062A \u0628\u0648\u0627\u0633\u0637\u0629' : 'Uploaded by'}</dt>
                  <dd className="text-gray-900">{selectedMaterial.userName || selectedMaterial.userEmail || 'Unknown'}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u062A\u0627\u0631\u064A\u062E \u0627\u0644\u0631\u0641\u0639' : 'Uploaded'}</dt>
                  <dd className="text-gray-900">{formatDate(selectedMaterial.createdAt)}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0627\u0644\u0645\u0634\u0627\u0647\u062F\u0627\u062A' : 'Views'}</dt>
                  <dd className="text-gray-900">{selectedMaterial.viewCount}</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-gray-500">{isRTL ? '\u0627\u0644\u062A\u0646\u0632\u064A\u0644\u0627\u062A' : 'Downloads'}</dt>
                  <dd className="text-gray-900">{selectedMaterial.downloadCount}</dd>
                </div>
